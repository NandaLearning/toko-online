...
function Cart() {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="relative w-full mt-20 bg-white">
        {cart.map((product, index) => (
          <div key={index} className="flex items-center">
            ...
            <h1 className="ml-3 text-2xl">{product.nama}</h1>
            <div className="flex items-center ml-auto mr-5">
              ...
              <button
                className="bg-green-400 w-8 h-7 rounded-lg ml-2"
                onClick={() => handleIncreaseClick(index)}
              >
                <h1 className="text-center text-lg font-bold text-white">+</h1>
              </button>
              <button
                className="bg-red-500 w-20 h-8 rounded-lg text-white font-bold ml-3"
      ...
      <div className=" w-full h-20 bg-white border border-gray-400 mt-96">
